# -*- coding: utf-8 -*-
"""
Created on Wed Oct  4 18:26:42 2017
...
X = dataset.iloc[:, 3].values   # Matrix of features X
...
plt.title('Sales vs Advertsising budget for NEWSPAPER (Training set)')
plt.xlabel('Advertising budget for NEWSPAPER')
plt.ylabel('Sales')
plt.show()
